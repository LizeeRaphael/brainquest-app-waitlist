    ...
    <main className="min-h-screen flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-12 bg-gradient-to-r from-green-500 via-white to-green-500">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left space-y-6">
        ...
        <form
          ...
          className="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-3 w-full max-w-md"
        >
          <input
            type="email"
            required
          ...
          <div className="flex flex-col items-center md:items-start space-y-2">
            ...
            <div className="flex items-center justify-center md:justify-start mt-1">
              ...
              <p className="text-gray-700 font-medium text-sm">
                Join <span className="text-green-600 font-semibold">2,547</span>{" "}
